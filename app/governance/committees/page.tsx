        ...
        content: (
          <div className="space-y-6">
            ...
            <div className="p-6 bg-primary-50 dark:bg-primary-900/30 rounded-lg border border-primary-200 dark:border-primary-700">
              <h4 className="font-bold text-primary-800 dark:text-white mb-3">Committee Categories</h4>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={idx} className="p-6 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                <h4 className="font-bold text-primary-800 dark:text-white mb-2">{committee.name}</h4>
                <p className="text-sm text-primary-500 font-semibold mb-3">Chair: {committee.chair}</p>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={idx} className="p-4 bg-gradient-to-br from-primary-50 to-transparent dark:from-primary-900/30 rounded-lg border-l-4 border-l-primary-500">
                <h4 className="font-bold text-primary-800 dark:text-white mb-1 text-sm">{aspect.title}</h4>
